...
const DeleteOutgoingModal = ({ isOpen, onClose, onConfirm, outgoingId }) => {
      ...
      >
        ...
        <div className="px-6 py-8 text-center text-white">
          ...
          <p className="text-slate-300 text-base leading-relaxed">
            Are you sure you want to delete <span className="text-white font-bold">{outgoingId || "this record"}</span>? <br />
...
export default DeleteOutgoingModal;
